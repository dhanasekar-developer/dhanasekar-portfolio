...
const Theme = ({ hideAndShowTheme, ref }) => {
  ...
  return (
    <div ref={ref} className={`bg-primary-three z-10 shadow-shadow_8 h-auto w-[250px] fixed top-[100px] rounded-md py-[10px] px-[20px] duration-700 -right-[300px] ${ dark ? 'border-2 border-gray-500' : '' } `}>
        <div>
