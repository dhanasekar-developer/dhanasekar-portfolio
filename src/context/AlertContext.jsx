    ...
    <AlertContext.Provider value={{ showAlert, closeAlert }}>
      ...
      {isOpen && (
        <div className="fixed inset-0 flex items-center justify-center text-secondary-one">
          <div className="fixed z-[60] inset-0 flex items-center justify-center bg-secondary-one opacity-[.12]"></div>
          <div className={`bg-primary-one border-[3px] border-theme-color rounded-xl shadow-shadow_9 w-[90%] max-w-md text-center space-y-4 !z-[100] `}>
